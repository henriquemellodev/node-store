...
const ValidationContract = require('../validators/fluidValidators');
...
exports.post = async (req, res, next) => {
    ...
    contract.isEmail(req.body.email, 'A Email Inválido. ');
...
exports.delete = async (req, res, next) => {
    try {
        ...
        res.status(201).send({ message: 'Conta removida com sucesso! ' });
    } catch (e) {
        console.log(e);
        res.status(400).send({
            message: 'Falha ao processar sua requisição!'
